...
- Desarrollar un sistema de reconocimiento de lenguaje de señas en tiempo real
- Implementar técnicas de deep learning para clasificación de gestos
...
- Ampliar el conjunto de letras y palabras reconocidas
- Optimizar el rendimiento del modelo
- Mejorar la precisión en condiciones de iluminación variable
- Añadir soporte para frases completas del lenguaje de señas
...
- Sean respetuosos con todos los miembros de la comunidad
